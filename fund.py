...
class fond(object):
    ...
    def getWorth(self,fscode):  
        ...
        gs_time=jsonObj.get('gztime')
        return name,yes_price,gs_price,gs_zf,gs_time
    def main(self):
        ...
        for code in allCode:
          try:
            name,yes_price,gs_price,gs_zf,gs_time = self.getWorth(code)
          except:
            continue
          gs_profit=round((float(gs_price)-float(yes_price))*float(share.get(code)), 2)
          gs_Sumprofit=round(gs_profit+gs_Sumprofit, 2)
        ...
        allCode =["161725","217027","009549","000751","001548","162712","110011","160221"]                     # 基金的代码 
        share =  {'161725':'7.73','217027':'42.28','009549':'216','000751':'45.25','001548':'149.75','162712':'6.97','110011':'7.62','160221':'0'}   # 持有基金所对应的份额
        ...
        for code in allCode:
          try:
            ...
            continue
          gs_profit=round((float(gs_price)-float(yes_price))*float(share.get(code)), 2)
          gs_Sumprofit1=round(gs_profit+gs_Sumprofit1, 2)
          print(code,name,"昨日净值："+yes_price,"估算值："+gs_price,"估算涨幅："+gs_zf+"%","估算收益："+str(gs_profit)+"元") 
          netWorthFile.write("\'"+code+"\',")  
          netWorthFile.write(name+","+yes_price+","+gs_price+","+gs_zf+","+str(gs_profit))
          netWorthFile.write("\n")
        ...
        netWorthFile.close()
        return str(round(gs_Sumprofit+gs_Sumprofit1, 2)),gs_time